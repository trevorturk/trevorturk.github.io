...
summary: "The sequel to adversarial review rounds: after weeks of running them, the failure mode wasn't bad reviews - it was auto-acting on them. The fix is a user checkpoint and one sentence: the digest is a filter, not a to-do list."
