...
A week after the web repo's plans sweep, a review checked all 59 skill sections the sweep had migrated out of plans. Only 44% met the bar. The rest carried decision-log narration that a future session would have to read past to find the rule.
