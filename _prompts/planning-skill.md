...
**Rewrite (2026-09-03):** Plain-register pass, pilot for issue #66, after a reader said the posts read like AI. Archive batch 5, the last, run after batch 4 (#72) merged. This post's prose was rewritten in plain register: "living document" and "handoff-ready" are now defined where they first appear, the numbered-name and kebab-case jargon became "lowercase words joined by hyphens", cleft and passive constructions became subject-first sentences with "we", and three closers that restated their sections were cut ("This is non-negotiable", "Plans are scaffolding...", and "The plan served its purpose and was removed"). Judgment calls: the quoted skill lists (Philosophy, the checklists, and the Never/Always rules) were left word for word as quoted text, and the Lessons Learned bullets were reworded as plain rules without changing what they say. Code blocks, headings, dates, numbers, links, and facts are unchanged. Prompts, verbatim:
